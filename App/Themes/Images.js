...
const images = {
  ...
  launch: require('../Images/007_logo.png'),
  ...
  flights: require('../Images/Icons/airplane-shape.png'),
  time: require('../Images/Icons/time.png'),
  help: require('../Images/Icons/help-round-button.png'),
  parking: require('../Images/Icons/parking.png'),
